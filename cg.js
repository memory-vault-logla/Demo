...
const f_info = [
  ["XX/09/2006", "XX/08/2006", "XX/04/2006",
 "XX/08/2006", "XX/07/2006", "XX/03/2007",
 "XX/01/2006", "XX/07/2006", "XX/10/2006",
 "XX/05/2005"],
  ...
  ["22xxx-cs-060", "22xxx-cs-012", "22xxx-cs-109",
   "22xxx-cs-034", "22xxx-cs-145", "22xxx-cs-098",
   "22xxx-cs-087", "22xxx-cs-073", "22xxx-cs-041",
   "22xxx-cs-127"],
  
  ["+91 99XXXXXX85", "+91 62XXXXXX02", "+91 93XXXXXX45",
   "+91 96XXXXXX63", "+91 91XXXXXX52", "+91 79XXXXXX30",
   "+91 84XXXXXX39", "+91 78XXXXXX41", "+91 96XXXXXX31",
   "+91 93XXXXXX36"],
  
  ["shashank@gmail.com", "kumaraswamy@gmail.com", "jeevansai@gmail.com",
   "ronith@gmail.com", "srihan@gmail.com", "suhasanand@gmail.com",
   "saikiran@gmail.com", "arjunsagar@gmail.com", "sidhartha@gmail.com",
...
const notice_f=(h,b)=>{
  const notic_space=document.querySelector(".notic_space");
  const notic=document.querySelector(".notic");
  
  
   notic.style.scale=`0.1`;
    notic.style.opacity="0";
      notic_space.style.display="flex";
    setTimeout(()=>{
      notic.style.scale=`1`;
    notic.style.opacity="1";
    },100)
  const notic_close_space=document.querySelector(".notic_close_space");
 const n_close=()=>{
    notic.style.scale=`0.1`;
    notic.style.opacity="0";
    setTimeout(()=>{
      notic_space.style.display="none";
      notic.style.scale=`1`;
    notic.style.opacity="1";
    },400)
  }
  notic_close_space.addEventListener("click",()=>{
    n_close();
  }
)
notic_space.addEventListener("click",()=>{
    n_close();
  }
)
  const notic_head=document.querySelector(".notic_head");
  notic_head.innerText=h;
  const notic_body=document.querySelector(".notic_body");
  notic_body.innerHTML=b;
  }
...
function info_box_creation(){
 ...
 const info_space_box_remaining=document.querySelector(" .info_space_box_remaining")
 info_close=()=>{
  ...
  info_space_box_remaining.addEventListener("click",()=>{
    info_close();
  })
...
info_space_box_c.append(info_space_box_c_open);
  ...
  info_space_box_cs.append(info_space_box_cs_name);
    ...
    const info_space_box_cs_name=document.createElement("div");
  info_space_box_cs_name.classList.add("info_space_box_cs_name");
  info_space_box_cs_name.innerText=i_cs[i][j];
 ...
 b=`The purpose of this page is to offer a preview of what <strong>College Gang</strong> is all about — a platform created to <strong>preserve college and school memories</strong> in one beautiful space. <br><br>
  ...
  This <strong>demo version</strong> is designed to give you a real feel of the experience. <br>
  Explore it, imagine your own gang’s vault, and see how <strong>College Gang</strong> can make your memories last forever.
`
 notice_f(h,b);
 })
  info_space_box_cs.append(info_space_box_cs_name);
...
<p>
  ...
  <ul style="margin-top: 10px; margin-bottom: 10px; padding-left: 20px; list-style-type: disc;">
    <li>Gang Name and Password are pre-filled for you.</li>
    <li>Just click <strong>“Visit Now”</strong> to explore the full experience!</li>
  </ul>

  <p>Take a glimpse into how College Gang helps preserve:</p>
  ...
  <p style="margin-top: 15px; ">
    <strong>Note:</strong> This is only a demo. In the full version, each gang gets their own private space to share and cherish memories.
  </p>
       `;
